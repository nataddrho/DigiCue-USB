...
class SerialPortSelect:
	...
	def __init__(self,master):	
		...
		self.listbox.pack()
		self.button = Tk.Button(master, text="OK", width=5, command=self.button_action)
		self.button.pack()		
	...
	def button_action(self):
		...
		try:
			...
			f.close()		
			self.label_text.set("Success. %s saved as BLED112 comport."%self.portref[index])			
		except:
