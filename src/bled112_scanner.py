...
import sys, optparse, serial, struct, time, datetime, re, signal, traceback
...
"""
    ...
    p.set_defaults(port=COMPORT, baud=57600, interval=0xC8, window=0xC8, display="trpsabd", uuid=[], mac=[], rssi=0, active=False, quiet=False, friendly=False)
